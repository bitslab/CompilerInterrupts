  ...
  do
    ...
    do
      ...
      *)
      ...
      BUILD_LOG=$BUILD_DEBUG_FILE ERROR_LOG=$BUILD_ERROR_FILE ALLOWED_DEVIATION=$AD CLOCK_TYPE=1 PUSH_INTV=$PI CMMT_INTV=$CI CYCLE_INTV=$cycles INST_LEVEL=$CI_SETTING PROFILE_FLAGS="-DAVG_STATS" make -f Makefile.ci ${bench}
