...
ci_perf_test() {
  ...
  do
    ...
    do
      ...
      ALLOWED_DEVIATION=$AD CLOCK_TYPE=1 PUSH_INTV=$PI CMMT_INTV=$CI CYCLE_INTV=$cycles INST_LEVEL=$CI_SETTING make -f Makefile.lc >>$BUILD_DEBUG_FILE 2>>$BUILD_ERROR_FILE
