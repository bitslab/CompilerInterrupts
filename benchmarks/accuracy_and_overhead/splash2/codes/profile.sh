...
#PI="2500 5000 10000 15000 20000 25000 30000 35000"
#PI="250 500 1000 1500 2500"
    for pi in $PI; do 
      ...
      BUILD_LOG=$BUILD_DEBUG_FILE ERROR_LOG=$BUILD_ERROR_FILE ALLOWED_DEVIATION=$AD CLOCK_TYPE=$CLOCK PUSH_INTV=$pi CMMT_INTV=$CI FIBER_CONFIG=50 CYCLE_INTV=$CYCLE INST_LEVEL=$ACC_SETTING EXTRA_FLAGS="-DAVG_STATS -DINTV_SAMPLING -DRUNNING_MEDIAN" make -f Makefile.lc ${bench} 
#BUILD_LOG=$BUILD_DEBUG_FILE ERROR_LOG=$BUILD_ERROR_FILE ALLOWED_DEVIATION=$AD CLOCK_TYPE=$CLOCK PUSH_INTV=$pi CMMT_INTV=$CI FIBER_CONFIG=50 CYCLE_INTV=$CYCLE INST_LEVEL=$ACC_SETTING EXTRA_FLAGS="-DAVG_STATS -DINTV_SAMPLING" make -f Makefile.lc ${bench} 
...
if [ $# -eq 0 ]; then
  if [ 1 -eq 1 ]; then
    ...
    PI="200 500 1000 2000 5000 10000 15000 20000 25000 30000 35000 40000 45000 50000 75000 100000 150000"
    ...
    #PI="5000 10000 15000 20000 25000 30000 35000 40000"
    ...
    #PI="50 100 250 500 750 1000 1250 1500"
    ...
    ACC_SETTING=$OPT_INTERMEDIATE
    app_acc_profile_test water-nsquared 55000
    app_acc_profile_test water-nsquared 60000
    app_acc_profile_test water-nsquared 65000
    app_acc_profile_test water-nsquared 70000
    app_acc_profile_test water-nsquared 75000
    app_acc_profile_test water-nsquared 90000
    app_acc_profile_test water-spatial 55000
    app_acc_profile_test water-spatial 60000
    app_acc_profile_test water-spatial 65000
    app_acc_profile_test water-spatial 70000
    app_acc_profile_test water-spatial 75000
    app_acc_profile_test water-spatial 90000
    app_acc_profile_test radix 1000
    app_acc_profile_test radix 1500
    exit
  fi
else
  PI="2000 5000 10000 15000 20000 25000 30000 35000 40000 45000 50000"
