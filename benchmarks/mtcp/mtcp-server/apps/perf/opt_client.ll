...
if.end63:                                         ; preds = %if.else49, %if.then40, %if.else, %if.then11
...
if.end145:                                        ; preds = %if.then141, %if.end137
  ...
  br i1 %cmp147483, label %if.then149, label %for.cond.preheader.preheader, !dbg !422

for.cond.preheader.preheader:                     ; preds = %if.end145
  br label %for.cond.preheader, !dbg !423

while.cond.loopexit.loopexit:                     ; preds = %if.else184
  br label %while.cond.loopexit, !dbg !418

while.cond.loopexit:                              ; preds = %while.cond.loopexit.loopexit, %for.cond.preheader
  ...
  br i1 %cmp147, label %if.then149.loopexit, label %for.cond.preheader, !dbg !422

for.cond.preheader:                               ; preds = %for.cond.preheader.preheader, %while.cond.loopexit
  %call146484 = phi i32 [ %call146, %while.cond.loopexit ], [ %call146482, %for.cond.preheader.preheader ]
  call void @llvm.dbg.value(metadata i32 0, metadata !130, metadata !DIExpression()), !dbg !218
  %cmp156480 = icmp sgt i32 %call146484, 0, !dbg !425
  br i1 %cmp156480, label %for.body.preheader, label %while.cond.loopexit, !dbg !423, !llvm.loop !427

for.body.preheader:                               ; preds = %for.cond.preheader
  %wide.trip.count489 = zext i32 %call146484 to i64, !dbg !425
  br label %for.body, !dbg !423

if.then149.loopexit:                              ; preds = %while.cond.loopexit
  br label %if.then149, !dbg !430

if.then149:                                       ; preds = %if.then149.loopexit, %if.end145
...
if.else184:                                       ; preds = %for.body
  ...
  %exitcond490 = icmp eq i64 %indvars.iv.next488, %wide.trip.count489, !dbg !425
  br i1 %exitcond490, label %while.cond.loopexit.loopexit, label %for.body, !dbg !423, !llvm.loop !468

end_wait_loop:                                    ; preds = %if.end178, %if.end126
...
if.then218:                                       ; preds = %while.cond209
  %add215.lcssa = phi i32 [ %add215, %while.cond209 ], !dbg !504
...
while.cond221.outer.loopexit:                     ; preds = %for.inc285
  %bytes_sent.3.lcssa = phi i32 [ %bytes_sent.3, %for.inc285 ], !dbg !218
  %sent_close.2.lcssa = phi i32 [ %sent_close.2, %for.inc285 ], !dbg !218
  call void @llvm.dbg.value(metadata i32 %bytes_sent.3.lcssa, metadata !171, metadata !DIExpression()), !dbg !218
  call void @llvm.dbg.value(metadata i32 %sent_close.2.lcssa, metadata !174, metadata !DIExpression()), !dbg !218
  br label %while.cond221.outer, !dbg !521

while.cond221.outer:                              ; preds = %while.cond221.outer.loopexit, %if.then218
  %bytes_sent.1.ph = phi i32 [ %add215.lcssa, %if.then218 ], [ %bytes_sent.3.lcssa, %while.cond221.outer.loopexit ]
  %sent_close.0.ph = phi i32 [ 0, %if.then218 ], [ %sent_close.2.lcssa, %while.cond221.outer.loopexit ]
  br label %while.cond221, !dbg !521

while.cond221:                                    ; preds = %while.cond221, %while.cond221.outer
...
for.body230.preheader:                            ; preds = %while.cond221
  %call225.lcssa = phi i32 [ %call225, %while.cond221 ], !dbg !523
  %wide.trip.count = zext i32 %call225.lcssa to i64, !dbg !525
...
for.inc285:                                       ; preds = %if.then275, %if.else273, %if.then267, %if.else256, %if.then245
  ...
  br i1 %exitcond, label %while.cond221.outer.loopexit, label %for.body230, !dbg !521, !llvm.loop !557

stop_timer:                                       ; preds = %if.then245
  %bytes_sent.2476.lcssa1 = phi i32 [ %bytes_sent.2476, %if.then245 ]
  %call248.lcssa = phi i64 [ %call248, %if.then245 ], !dbg !533
  call void @llvm.dbg.value(metadata i32 %bytes_sent.2476.lcssa1, metadata !171, metadata !DIExpression()), !dbg !218
  call void @llvm.dbg.value(metadata i32 %bytes_sent.2476.lcssa1, metadata !171, metadata !DIExpression()), !dbg !218
  call void @llvm.dbg.value(metadata i32 %bytes_sent.2476.lcssa1, metadata !171, metadata !DIExpression()), !dbg !218
  call void @llvm.dbg.value(metadata i32 %bytes_sent.2476.lcssa1, metadata !171, metadata !DIExpression()), !dbg !218
  %conv249.le = trunc i64 %call248.lcssa to i32, !dbg !533
  call void @llvm.dbg.value(metadata i32 %bytes_sent.2476.lcssa1, metadata !171, metadata !DIExpression()), !dbg !218
  call void @llvm.dbg.value(metadata i32 %bytes_sent.2476.lcssa1, metadata !171, metadata !DIExpression()), !dbg !218
  call void @llvm.dbg.value(metadata i32 %bytes_sent.2476.lcssa1, metadata !171, metadata !DIExpression()), !dbg !218
  ...
  %call301 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([22 x i8], [22 x i8]* @.str.42, i64 0, i64 0), i32 %bytes_sent.2476.lcssa1), !dbg !581
  %conv302 = sitofp i32 %bytes_sent.2476.lcssa1 to double, !dbg !582
...
cleanup308:                                       ; preds = %stop_timer, %if.then200, %if.then153, %if.then149, %if.then124, %if.then118, %if.then111, %if.then88, %if.then70, %if.end59, %if.then27, %if.then4, %if.then
...
!423 = !DILocation(line: 270, column: 4, scope: !424)
!424 = distinct !DILexicalBlock(scope: !419, file: !10, line: 270, column: 4)
!425 = !DILocation(line: 270, column: 18, scope: !426)
!426 = distinct !DILexicalBlock(scope: !424, file: !10, line: 270, column: 4)
...
!440 = distinct !DILexicalBlock(scope: !426, file: !10, line: 270, column: 34)
...
!467 = !DILocation(line: 270, column: 30, scope: !426)
!468 = distinct !{!468, !423, !469}
!469 = !DILocation(line: 290, column: 4, scope: !424)
